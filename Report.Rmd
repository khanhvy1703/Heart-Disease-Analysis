...
![Figure 1: Age Distribution of Heart Disease Prevalence](images/figure1.3.png){width=306px}
![Figure 2: Heart Disease Mortality Cases in Different Regions](images/figure2.2.png){width=306px}
...
![Figure 3: Medical History Distribution by Heart Attack Status](images/figure3.2.png){width=306px}
![Figure 4: Health Condition by Age Category](images/figure4.2.png){width=306px}
...
![Figure 5: LifeStyle Distribution by Heart Attack Status](images/figure5.2.png){width=305px}
![Figure 6: Counts of Drinkers & Smokers by Different Age Category](images/figure6.2.png){width=305px}
...
| Controls the range of weight initialization 	|  0.1 	|
| Decay	|  0.0005 	|
| Maximum number of training iterations  	|  1000 	|


Table: Training Parameters of Neural Network Model
...
Table: Linear Regression Model Evaluation
...
| Exploratory Data Analysis          | \checkmark | \checkmark |  |  |
