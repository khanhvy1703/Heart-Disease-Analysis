...
Try with other factors `Stratification1` and `Stratification2` (sex, races) to see if model will better:
```{r}
# one-hot code Stratification1 and Stratification2
cdc <- cbind(cdc, model.matrix(~ Stratification1 + Stratification2 - 1, data = cdc))
```

Apply linear regression and run prediction in the new model:
```{r}
# rename the model
